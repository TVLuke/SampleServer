...
public class NanoHTTPD {
    ...
    private class HTTPSession implements Runnable {
        ...
        public void run() {
            try {
                ...
                if (method.equalsIgnoreCase("PUT")){
                    String fileName = saveTmpFile(fbuf, 0, f.size(), "empty");
            ...
            {
                //This happens and it kills the entire programm...
                stop();
            }
        }
                    ...
                    if (mpline != null) {
                        ...
                        if (item.getProperty("content-type") == null) {
                            ...
                            String path = saveTmpFile(fbuf, offset,
                                    bpositions[boundarycount - 1] - offset - 4, value);
         ...
         **/
        private String saveTmpFile(byte[] b, int offset, int len, String name) {
            String path = "";
            if (len > 0) {
                File rootsd = Environment.getExternalStorageDirectory();
                File dir = new File(rootsd.getAbsolutePath() + "/Discover Control/HMI");
